const questionnaire = {
    sections: {
        ...
        6: {
            ...
            content: "תחנת כוח תרמו-סולארית, הידועה גם כתחנת כוח סולארי מרוכז, משתמשת במראות או עדשות לריכוז אור השמש כדי לייצר חום, שמשמש לאחר מכן לייצור חשמל. טכנולוגיה זו יכולה לאחסן אנרגיה תרמית לשימוש כאשר השמש אינה זורחת, מה שמאפשר אספקת חשמל יציבה יותר ממערכות פוטו-וולטאיות.\n\nיחד עם זאת... תחנות תרמו-סולאריות דורשות משאבי קרקע ומים משמעותיים לקירור. בנוסף, הבנייה והתחזוקה של תחנות אלו עלולות להיות יקרות מאוד.",
